...
namespace OCSPatchers.Patchers.NewItems
{
    ...
    {
        public override string PatchFileNameWithoutExtension => "Xenoblade2 Pyra";
    ...
    {
        public override string PatchFileNameWithoutExtension => "Xenoblade2 Mythra";
    ...
    {
        public override string PatchFileNameWithoutExtension => "Sonya Blade!";
    ...
    {
        public override string PatchFileNameWithoutExtension => "FFVII Cloud Strife";
    ...
    {
        public override string PatchFileNameWithoutExtension => "FF7 Yuffie";
    ...
    {
        public override string PatchFileNameWithoutExtension => "FFVII Yuffie Kisaragi";
    ...
    {
        public override string PatchFileNameWithoutExtension => "TIFA";
    ...
    {
        public override string PatchFileNameWithoutExtension => "FFVII Aerith";
    ...
    {
        public override string PatchFileNameWithoutExtension => "Lightning";
    ...
    {
        public override string PatchFileNameWithoutExtension => "Witcher 3 VES";
    ...
    {
        public override string PatchFileNameWithoutExtension => "The Witcher";
        protected override string[] NpcStringIDsToCheck => new string[] { 
    ...
    {
        public override string PatchFileNameWithoutExtension => "The Witcher tweaks";
        protected override string[] NpcStringIDsToCheck => new string[] {
    ...
    {
        public override string PatchFileNameWithoutExtension => "Sekiro tweaks";
        protected override string[] NpcStringIDsToCheck => new string[] {
            "49-Sekiro.mod", 
        };
    }
    ...
    {
        public override string PatchFileNameWithoutExtension => "MAI";
        protected override string[] NpcStringIDsToCheck => new string[] {
            "5007305-MAI.mod", 
        };
    }
    ...
    {
        public override string PatchFileNameWithoutExtension => "Underworld";
        protected override string[] NpcStringIDsToCheck => new string[] {
            "15-Underworld.mod", 
        };
    }
    ...
    {
        public override string PatchFileNameWithoutExtension => "Cyberpunk 2077 V";
        protected override string[] NpcStringIDsToCheck => new string[] {
    ...
    {
        public override string PatchFileNameWithoutExtension => "Ashley Graham";
        protected override string[] NpcStringIDsToCheck => new string[] {
