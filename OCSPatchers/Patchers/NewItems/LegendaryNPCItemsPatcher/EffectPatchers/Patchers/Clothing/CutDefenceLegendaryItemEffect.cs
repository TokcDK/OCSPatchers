...
{
    internal class CutDefenceLegendaryItemEffect : LegendaryItemEffectItemFloatBase
    {
        public override string Name => "Защита от разреза";

        public override string Description => $"#afa68b{Name} #a8b774+{VALUE*100}%";

        protected override string KEY_NAME => "cut def bonus";
