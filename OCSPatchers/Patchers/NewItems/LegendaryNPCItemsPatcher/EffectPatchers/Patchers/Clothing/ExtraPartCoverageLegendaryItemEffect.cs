...
namespace OCSPatchers.Patchers.NewItems.LegendaryNPCItemsPatcher.EffectPatchers.Patchers
{
    internal class ExtraPartCoverageLegendaryItemEffect : ExtraCoverageLegendaryItemEffect
    {
        ...
        public override bool TryApplyClothingEffect(ModItem modItem, OpenConstructionSet.Mods.Context.IModContext context)
        {
            ...
            // для головы это голова - грудь - живот - правая рука - левая рука - правая нога - левая нога
            // для штанов это живот - грудь - голова - правая рука - левая рука
            // для брони это грудь - живот - голова - правая рука - левая рука - правая нога - левая нога
            // для рубашки это грудь - живот - голова - правая рука - левая рука - правая нога - левая нога
